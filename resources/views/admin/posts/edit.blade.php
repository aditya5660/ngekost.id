...
<div class="content-area5 dashboard-content">
    <div class="dashboard-header clearfix">
        <div class="row">
            <div class="col-sm-12 col-md-6"><h4>Update Post</h4></div>
    ...
    <div class="submit-address dashboard-list">
            ...
            <h4 class="bg-grea-3">Create Post</h4>
                <div class="row pad-20">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="input-text" name="title" placeholder="Post Title"  value="{{$post->title}}">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            <label>Post Category</label>
                            <select name="categories" class="selectpicker search-fields"  data-live-search="true" value="{{$post->category_id}}">
                ...
                <div class="col-lg-12">
                    <label>Body</label>
                    <textarea class="input-text" name="body" id="body" >{{$post->body}}</textarea>
                </div>
