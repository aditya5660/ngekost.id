...
<body style="background: #F9F9F9;">
    <div style="background-color:#F9F9F9;">
                                        ...
                                        <tr>
                                            <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                                <table role="presentation" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:138px;"><a href="https://ngekost.id/"
                                                                    target="_blank"><img alt="" title="" height="38px"
                                                                        src="{{asset('logo/logo-blue.png')}}"
        ...
        <div
            ...
            <div
                style="margin:0px auto;max-width:640px;background:#7289DA url({{asset('logo/email_assets.png')}}) top center / cover no-repeat;">

                <table role="presentation" cellpadding="0" cellspacing="0"
                    style="font-size:0px;width:100%;background:#7289DA url({{asset('logo/email_assets.png')}}) top center / cover no-repeat;"
                    align="center" border="0"
                    background="{{asset('logo/email_assets.png')}}">
                    <tbody>
                        <tr>
                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:57px;">

                                <div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;"> Welcome to Ngekost.id! </div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                        ...
                                        <tr>
                                            <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                                <div
                                                    ...
                                                    Sent by Ngekost.id • <a href="https://ngekost.id/blog"
                                                        style="color:#1EB0F4;text-decoration:none;"
                                                        target="_blank">Privacy Policy </a> | <a
                                                        href="https://twitter.com/ngekostid"
                                                        style="color:#1EB0F4;text-decoration:none;"
