...
--
-- Host: localhost
-- Generation Time: Jul 27, 2019 at 06:58 AM
...
(1, 'Wifi', 'fa fa-wifi', '2019-07-02 20:51:44', '2019-07-02 21:08:00'),
(2, 'TV', 'fa fa-tv', '2019-07-02 21:01:42', '2019-07-02 21:11:25'),
(3, 'Kamar Mandi', 'fa-bath', '2019-07-02 21:01:53', '2019-07-02 21:01:53'),
(4, 'Piero', 'fa-laravel', '2019-07-07 19:57:35', '2019-07-07 19:57:35');
...
(1, 'Kost Putra', 'kost-putra', 'default.png', '2019-07-02 21:01:30', '2019-07-02 21:01:30');
...
(7, '2018_05_10_172731_create_post_category_table', 1),
(8, '2018_05_19_134221_create_amenities_table', 1),
(9, '2018_05_19_134753_create_feature_property_table', 1),
(10, '2018_07_06_171008_create_property_image_galleries_table', 1),
(11, '2018_07_18_042846_create_galleries_table', 1),
(12, '2018_08_12_081814_create_sliders_table', 1),
(13, '2018_08_12_113108_create_testimonials_table', 1),
(14, '2018_08_12_142529_create_albums_table', 1),
(15, '2018_08_15_194359_create_messages_table', 1),
(16, '2018_08_20_070748_create_settings_table', 1),
(17, '2018_08_24_073322_create_properties_table', 1),
(18, '2018_08_25_110649_create_comments_table', 1),
(19, '2018_09_04_183409_create_ratings_table', 1),
(20, '2018_10_17_153558_create_services_table', 1),
(21, '2019_06_30_030711_create_favorited_properties_table', 1),
(22, '2019_07_06_174535_create_transaction_table', 2);
...
INSERT INTO `posts` (`id`, `user_id`, `title`, `slug`, `image`, `body`, `view_count`, `status`, `is_approved`, `category_id`, `created_at`, `updated_at`) VALUES
(5, 1, 'Contoh Post', 'contoh-post', 'asdasd-2019-07-04-5d1e13e6a516f.png', '<p>asdasd</p>', 4, 1, 1, NULL, '2019-07-04 07:57:43', '2019-07-12 19:53:48');
...
INSERT INTO `post_category` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Tips dan Trik', 'tips-dan-trik', '2019-07-03 06:53:48', '2019-07-07 19:13:39'),
(2, 'admin', 'admin', '2019-07-07 19:58:31', '2019-07-07 19:58:31');
...
CREATE TABLE `properties` (
  ...
  `provinces` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `regencies` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `districts` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `zipcode` int(11) NOT NULL,
  `daily_price` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `monthly_price` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `yearly_price` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_room_size` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `l_room_size` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `available_room` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) NOT NULL,
  `featured` tinyint(1) NOT NULL DEFAULT '0',
  `image` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `amenities_id` longtext COLLATE utf8mb4_unicode_ci,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `category_id` int(10) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `properties` (`id`, `title`, `slug`, `address`, `location_latitude`, `location_longitude`, `provinces`, `regencies`, `districts`, `zipcode`, `daily_price`, `monthly_price`, `yearly_price`, `p_room_size`, `l_room_size`, `available_room`, `status`, `featured`, `image`, `description`, `amenities_id`, `user_id`, `category_id`, `created_at`, `updated_at`) VALUES
(3, 'Kost Kawasan Klaten', 'kost-kawasan-klaten', 'jl. prawiro kuat 129b', '-7.759776', '110.408821', '34', '3404', '3404020', 55283, 'Rp. 123.123', 'Rp. 123.123', 'Rp. 123.123', '3', '3', '1', 0, 0, 'kost-kawasan-klaten-2019-07-03-5d1c3eb7aa903.png', '<p>qwepoqwiepoiqwe</p>', '1//2//3', 2, 1, '2019-07-02 22:35:52', '2019-07-02 22:49:40'),
(4, 'Kost Pak Sabar', 'kost-pak-sabar', 'jl. prawiro kuat 129b', '110.370529', '-7.797068', '34', '3404', '3404070', 55283, 'Rp. 50.000', 'Rp. 350.000', 'Rp. 4.000.000', '3', '3', '1', 1, 0, 'kost-pak-sabar-2019-07-03-5d1c88234d303.png', '<p>asdawoeiuqoiuwdlkajklwjdisad</p>', '1//2//3', 2, 1, '2019-07-03 03:49:07', '2019-07-03 03:59:25'),
(5, 'Codeigniter', 'codeigniter', 'jl. prawiro kuat 129b', '123123', '123123', '34', '3404', '3404050', 55283, '', 'Rp. 123.123', 'Rp. 123.123', '3', '3', '1', 1, 1, 'codeigniter-2019-07-03-5d1ca77012004.png', '<p>qweqwe</p>', '1', 2, 1, '2019-07-03 06:02:40', '2019-07-03 06:02:40'),
(6, 'Kost Kawasan 1', 'kost-kawasan-1', 'Jl. Ringroad Utara Amikom', '110.370529', '-7.797068', '34', '3404', '3404070', 55283, 'Rp. 100.000', 'Rp. 300.000', 'Rp. 3.000.000', '3', '3', '1', 1, 0, 'kost-kawasan-1-2019-07-15-5d2c2c23375ed.png', '<p>Sepeda Gunung</p><p>&nbsp;</p>', '1//2//3//4', 2, 1, '2019-07-15 00:32:51', '2019-07-15 00:32:51');
...
(11, 3, 'gallary-2019-07-03-5d1c41f4d4ad8.png', '283554', '2019-07-02 22:49:41', '2019-07-02 22:49:41'),
(12, 3, 'gallary-2019-07-03-5d1c41f535de6.png', '43636', '2019-07-02 22:49:41', '2019-07-02 22:49:41'),
(13, 3, 'gallary-2019-07-03-5d1c41f567c86.png', '252363', '2019-07-02 22:49:41', '2019-07-02 22:49:41'),
(14, 3, 'gallary-2019-07-03-5d1c41f5c0661.png', '206218', '2019-07-02 22:49:42', '2019-07-02 22:49:42'),
(15, 3, 'gallary-2019-07-03-5d1c41f627e5e.png', '124893', '2019-07-02 22:49:42', '2019-07-02 22:49:42'),
(16, 3, 'gallary-2019-07-03-5d1c41f674a6d.png', '52055', '2019-07-02 22:49:42', '2019-07-02 22:49:42'),
(17, 4, 'gallary-2019-07-03-5d1c8823ec4ff.png', '283554', '2019-07-03 03:49:08', '2019-07-03 03:49:08'),
(18, 4, 'gallary-2019-07-03-5d1c8824a7a7e.png', '43636', '2019-07-03 03:49:08', '2019-07-03 03:49:08'),
(19, 4, 'gallary-2019-07-03-5d1c8824edd14.png', '252363', '2019-07-03 03:49:09', '2019-07-03 03:49:09'),
(20, 4, 'gallary-2019-07-03-5d1c8825626d5.png', '206218', '2019-07-03 03:49:09', '2019-07-03 03:49:09'),
(21, 4, 'gallary-2019-07-03-5d1c8825cf23a.png', '124893', '2019-07-03 03:49:10', '2019-07-03 03:49:10'),
(22, 4, 'gallary-2019-07-03-5d1c882647041.png', '52055', '2019-07-03 03:49:10', '2019-07-03 03:49:10'),
(23, 5, 'gallary-2019-07-03-5d1ca770666ac.png', '43636', '2019-07-03 06:02:40', '2019-07-03 06:02:40'),
(24, 5, 'gallary-2019-07-03-5d1ca770a41bb.png', '252363', '2019-07-03 06:02:40', '2019-07-03 06:02:40'),
(25, 5, 'gallary-2019-07-03-5d1ca770e5ffc.png', '206218', '2019-07-03 06:02:41', '2019-07-03 06:02:41'),
(26, 6, 'gallary-2019-07-15-5d2c2c23acdf1.jpg', '41844', '2019-07-15 00:32:52', '2019-07-15 00:32:52'),
(27, 6, 'gallary-2019-07-15-5d2c2c2497444.jpg', '41854', '2019-07-15 00:32:53', '2019-07-15 00:32:53'),
(28, 6, 'gallary-2019-07-15-5d2c2c252b6c1.jpg', '36902', '2019-07-15 00:32:53', '2019-07-15 00:32:53'),
(29, 6, 'gallary-2019-07-15-5d2c2c25af0a5.jpg', '155290', '2019-07-15 00:32:54', '2019-07-15 00:32:54'),
(30, 6, 'gallary-2019-07-15-5d2c2c26468c6.jpg', '129399', '2019-07-15 00:32:54', '2019-07-15 00:32:54');
...
(1, 'Admin', 'admin', '2019-07-02 20:51:16', NULL),
(2, 'Owner', 'owner', '2019-07-02 20:51:16', NULL),
(3, 'Users', 'users', '2019-07-02 20:51:16', NULL);
...
(1, 'Ngekost.id', 'hello@ngekost.id', '0274-000-000', 'Ruko Casa Grande, Jl. Ring Road Utara No.25, Jenengan, Maguwoharjo, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55283', 'Cari Kost? ya di ngekost.id', 'Ngekost.id web application menyajikan informasi Kamar kosan, lengkap dengan fasilitas kost, harga kost, dan dekorasi kamar beserta foto desain kamar yang disesuaikan dengan kondisi sebenarnya. Setiap Rumah Kost yang ada di Kosan.id benar-benar kami datangi, kami verifikasi, kami seleksi dan kami ambil data langsung, termasuk kost yang didaftarkan oleh pemilik atau umum. Informasi ketersediaan kamar kost dan harga kost kami update max setiap 2 minggu sekali untuk memastikan info kost kami akurat dan bermanfaat untuk anak kost.', 'https://www.facebook.com/adt12', 'https://www.twitter.com/adt12', 'https://www.linkedin.com/in/adityaproject', NULL, '2019-07-07 02:24:00');
...
(4, 'Cari Kost? Ya di ngekost.id', 'ini deskripsi', 'cari-kost-ya-di-ngekostid-2019-07-26-5d3a68d5da898.png', '2019-07-25 19:37:32', '2019-07-25 19:43:35');
...
CREATE TABLE `transaction` (
  ...
  `booking_range` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `start_booking_date` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `subtotal` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payments` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `transaction` (`id`, `user_id`, `property_id`, `owner_id`, `booking_range`, `start_booking_date`, `subtotal`, `payments`, `payment_slip`, `status`, `created_at`, `updated_at`) VALUES
(4, 3, 5, 2, '3', '2019-07-31', 'Rp. 123.123', '2', NULL, 3, '2019-07-07 08:24:04', '2019-07-07 08:25:35'),
(5, 3, 4, 2, '3', '2019-07-30', 'Rp. 4.000.000', '2', NULL, 0, '2019-07-07 19:27:33', '2019-07-07 19:27:33'),
(6, 3, 4, 2, '2', '2019-07-31', 'Rp. 350.000', '2', NULL, 6, '2019-07-07 19:54:55', '2019-07-15 00:27:58'),
(7, 3, 6, 2, '3', '2019-08-01', 'Rp. 3.000.000', '1', NULL, 2, '2019-07-15 00:36:53', '2019-07-15 00:40:26'),
(8, 3, 4, 2, '3', '2019-07-31', 'Rp. 4.000.000', '1', NULL, 0, '2019-07-26 02:33:57', '2019-07-26 02:33:57');
...
INSERT INTO `users` (`id`, `role_id`, `name`, `username`, `email`, `phone`, `image`, `about`, `status`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 1, 'Admin', 'admin', 'admin@ngekost.id', '083861778343', 'admin-users-1-2019-07-07.jpg', 'Bio of admin', 0, '$2y$10$gJEGsTmcLwQyvSaHyYHxSewH9DnunHeNhK2buMrjpO9ouyD2RwtWe', NULL, '2019-07-02 20:51:15', '2019-07-07 01:46:24'),
(2, 2, 'Dimas Tri Awan', 'owner', 'owner@ngekost.id', '083861778343', 'dimas-tri-awan-agent-2-2019-07-05.jpg', 'asdasdasd', 1, '$2y$10$uPlou79IWKnVe4o5CPnZ8ODIWj.YuY3/OQTCZYzjKpcQcKrTvSz3G', NULL, '2019-07-02 20:51:15', '2019-07-04 21:25:36'),
(3, 3, 'Gilang Tunggul', 'user', 'users@ngekost.id', NULL, 'default.png', NULL, 1, '$2y$10$uPlou79IWKnVe4o5CPnZ8ODIWj.YuY3/OQTCZYzjKpcQcKrTvSz3G', NULL, '2019-07-02 20:51:15', NULL),
(4, 3, 'Jojo', 'Eka', 'gigi@ngekost.id', '0808080808', 'default.png', 'ndasm', 1, '$2y$10$f6M8DDgYjf800Nblr/jVtOYiR3sLylq4RFCYJTPW87DhDnRUBIZKa', NULL, '2019-07-14 06:24:48', '2019-07-14 21:48:59'),
(5, 3, 'Bima', 'bim', 'bima@ngekost.id', NULL, 'default.png', NULL, 1, '$2y$10$0OlWQ5LQNrAfw4ZO0mOByeqOizWVMQBS26x6l3v6HY05QEN.alm4G', NULL, '2019-07-14 21:47:18', '2019-07-14 21:47:18');
...
--
-- Indexes for table `favorited_properties`
--
ALTER TABLE `favorited_properties`
  ADD PRIMARY KEY (`id`),
  ADD KEY `favorited_properties_user_id_foreign` (`user_id`),
  ADD KEY `favorited_properties_property_id_foreign` (`property_id`);
...
ALTER TABLE `transaction`
  ...
  ADD KEY `transaction_property_id_foreign` (`property_id`);
...
--
-- AUTO_INCREMENT for table `favorited_properties`
--
ALTER TABLE `favorited_properties`
...
--
-- Constraints for table `favorited_properties`
--
ALTER TABLE `favorited_properties`
  ADD CONSTRAINT `favorited_properties_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `favorited_properties_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `posts`
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `post_category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `transaction_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
